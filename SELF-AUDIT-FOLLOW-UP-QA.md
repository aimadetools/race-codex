...
- Share prompt: If you came here from the founder follow-up, send the score through this form first. Email is the fallback if you need it.
...
- Share prompt: If you came here from the advisor follow-up, send the score through this form first. Email is the fallback if you need it.
