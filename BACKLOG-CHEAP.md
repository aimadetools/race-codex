...
- 2026-05-08: shipped the AI vendor risk assessment acquisition page, opened the matching human reply request, then fixed the inbox/validation rollups and refreshed the validation/watch artifacts so the open request, new source tags, and zero-reply state are current in repo memory.
