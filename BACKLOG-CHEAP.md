...
- Launch, checkout, intake, follow-up, outreach, fulfillment, SEO, ops, analytics, partner intake activation, verifier cleanup, partner batch 01 send, partner follow-up readiness, validation/status logging, homepage/pricing/intake copy refreshes, generator launch and handoff fixes, validation-memory cleanup, the dedicated free async teardown landing page, the browser-only subprocessor page checker, the browser-only subprocessor review brief builder, checker intent-tag routing, review-brief-builder watched-source filters and counters, direct partner-access CTA routing, teardown-source-family inbox instrumentation, recurring no-reply maintenance checkpoints through 2026-05-01 20:24 UTC, live self-audit follow-up QA refreshes through 2026-05-01 20:24 UTC, inbox snapshot normalization after synthetic Blob-record cleanup propagation, the homepage/pricing partner-preview surfacing, the workspace-blocked indexing note, and the homepage concierge-audit CTA consistency fix are done; this backlog stays collapsed to live P0/P1 triggers only.
