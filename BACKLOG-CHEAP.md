...
- Launch, checkout, intake, follow-up, outreach, fulfillment, SEO, ops, analytics, partner intake activation, verifier cleanup, partner batch 01 send, partner follow-up readiness, validation/status logging, homepage/pricing/intake copy refreshes, generator launch and handoff fixes, validation-memory cleanup, the dedicated free async teardown landing page, the browser-only subprocessor page checker, the browser-only subprocessor review brief builder, the vendor-change review packet guide, checker intent-tag routing, review-brief-builder watched-source filters and counters, direct partner-access CTA routing, repeated no-reply maintenance checkpoints through 2026-05-05 12:36 UTC, live self-audit follow-up QA refreshes through 2026-05-05 12:36 UTC, the 2026-05-05 live self-audit production verification refresh, the 2026-05-05 validation maintenance checkpoint refreshes, the post-verifier inbox/validation status resync fix after synthetic Blob cleanup, the homepage/pricing partner-preview surfacing, the sample async teardown deliverable page, the page-change-monitoring comparison page, the buyer-facing kit preview page, the buyer-path start-here guide, the free-tools acquisition hub, the expanded watched-source instrumentation for `free-tools`, `sample-teardown`, `kit-preview`, and `partner-client-handoff`, the deploy exclusion hardening for internal ops files, the homepage and pricing-page comparison CTAs, the workspace-blocked indexing note, the homepage concierge-audit CTA consistency fix, the partner follow-up CTA-variant tooling, the pricing-page FAQ schema refresh, the new site-link checker, and the 2026-05-05 partner follow-up pass plus the 2026-05-05 indexing help-request handoff and maintenance/site-link refresh are done; this backlog stays collapsed to live P0/P1 triggers only.
