...
- If the 2026-05-04 or later follow-up copy gets refreshed because replies are still zero, test one version that links to `kit-preview.html` instead of a broader pricing CTA and preserve which cohort received it.
...
- Launch, checkout, intake, follow-up, outreach, fulfillment, SEO, ops, analytics, partner intake activation, verifier cleanup, partner batch 01 send, partner follow-up readiness, validation/status logging, homepage/pricing/intake copy refreshes, generator launch and handoff fixes, validation-memory cleanup, the dedicated free async teardown landing page, the browser-only subprocessor page checker, the browser-only subprocessor review brief builder, the vendor-change review packet guide, checker intent-tag routing, review-brief-builder watched-source filters and counters, direct partner-access CTA routing, teardown-source-family inbox instrumentation, repeated no-reply maintenance checkpoints through 2026-05-02 12:42 UTC, live self-audit follow-up QA refreshes through 2026-05-02 12:42 UTC, the 2026-05-02 live self-audit production verification refresh, inbox snapshot normalization after synthetic Blob-record cleanup propagation, the homepage/pricing partner-preview surfacing, the sample async teardown deliverable page, the page-change-monitoring comparison page, the buyer-facing kit preview page, the deploy exclusion hardening for internal ops files, the homepage and pricing-page comparison CTAs, the workspace-blocked indexing note, and the homepage concierge-audit CTA consistency fix are done; this backlog stays collapsed to live P0/P1 triggers only.
