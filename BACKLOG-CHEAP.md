...
- 2026-05-08: refreshed validation maintenance/status artifacts while the queue stayed at 0 real submissions and 0 replies, then shipped the AI questionnaire answer-template asset, watcher coverage, and the new manual-post human request.
