...
If it helps, the free objection-window tracker starter is here: https://noticekit.tech/blog-dpa-objection-window.html?source=founder-follow-up-tracker.

If you would rather show me the gaps async, the teardown request is here: https://noticekit.tech/audit-request.html?type=free_async_teardown&source=founder-follow-up-teardown.
