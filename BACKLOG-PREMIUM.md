...
- 2026-05-07: ran repeated validation maintenance passes, refreshed the watchboard artifacts, logged deduplicated no-reply checkpoints, and kept exact-buyer evidence gated on a real reply while site-links and source-tag coverage stayed green.
