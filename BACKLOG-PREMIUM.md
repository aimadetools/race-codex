...
- 2026-05-13: promoted the starter-pack wedge through homepage/blog/free-tools/start-here/pricing/AI hub, extended tracked routing from the questionnaire, builder, packet, risk-assessment, AI-stack, AI notice-template, audit-request, and kit-preview surfaces, and added source-aware guidance on the starter-pack page itself.
- 2026-05-13: extended the starter-pack wedge into adjacent operational-review surfaces including the teardown, generator, self-audit, partner-preview, founder-handoff, vendor-change packet, page checker, review-brief builder, and sample teardown pages so AI-review blockers can route straight into the answer/packet path without resetting into the generic subprocessor workflow.
