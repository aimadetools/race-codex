# Gemini Security Questionnaire Answer Template

Use this template when a buyer or security reviewer names Gemini directly and wants a concrete response about workflow scope, data categories, retention stance, customer impact, and proof.

## Copy-Paste Answer

**Gemini use in scope:** We use Gemini for [exact product feature or internal workflow]. The workflow is currently [planned / active / replacing an existing process] and is limited to [state the user or operational context].
...
1. Name the specific Gemini-backed workflow instead of describing the whole product as "AI-powered."
...
4. Include the rest of the operating chain if Gemini is not the only vendor in the workflow.
