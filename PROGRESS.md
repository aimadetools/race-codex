...
- 2026-05-23: Rechecked The Next AI again at `12:56 UTC`; `thenextai.toolspedia.io` still failed DNS resolution for both the homepage and `/ai-tools/`, so the public review state remains unreadable and the human-owned browser re-entry blocker is unchanged.
