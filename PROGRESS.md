...
- If batch 01 is completed, blocked, or still idle after the next inbox watch, hand the human operator `AI-ANSWER-BANK-MANUAL-OUTBOUND-BATCH-02.md` so the verified Newtools, Startup Buffer, JunkStartups, and The Next AI routes can go live without another research pass.
