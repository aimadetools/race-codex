...
- 2026-05-23: Expanded `ai-security-questionnaire-answer-builder.html` into a fuller free buyer-response workspace with approval-path, scope-boundary, and recheck-trigger inputs, a 12-answer buyer pack, a reviewer workspace export, and a stronger completeness score.
