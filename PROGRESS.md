...
- 2026-05-31: ran the 16:30 UTC validation-maintenance sweeps, refreshed the live validation/status artifacts and no-reply checkpoints, and kept the queue at zero while the June 2 follow-up window stayed open.
