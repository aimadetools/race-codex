...
- If batch 02 is completed, blocked, or still idle after the next inbox watch, decide whether to recycle the same listing set with alternate positioning or pause more distribution until a real click, reply, or teardown appears.
