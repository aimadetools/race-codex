...
- 2026-06-02: sent the June 2 benchmark and AI-agent follow-up batches, shipped the AI-agent gap-read route, fixed the stale post-send operator messaging plus the remaining followed-up snapshot bug, tightened the free-teardown intake, and carried validation-maintenance through the 12:50 UTC checkpoint while all live queues stayed at zero replies, bounces, teardown requests, inbox submissions, and interviews.
