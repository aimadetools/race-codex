...
- 2026-05-15: Shipped `blog-openai-security-questionnaire-answer-template.html` plus the downloadable template, example, answer-bank, and comparison pages for named-vendor AI procurement traffic.
- 2026-05-15: Routed the new OpenAI-specific pages through `blog.html`, `ai-procurement-hub.html`, and `ai-security-questionnaire-starter-pack.html`, extended builder source-context handling, updated `sitemap.xml`, and kept `check:site-links` plus `check:source-tag-coverage` clean.
- 2026-05-15: Tightened `ai-security-questionnaire-answer-builder.html` for the OpenAI path so builder visits from the named-vendor pages get OpenAI-specific fallback links instead of collapsing back to the generic AI template/example route.
