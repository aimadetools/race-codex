...
- 2026-05-20: Sharpened `purchase-next-steps.html` and `pricing.html` so buyers can see the exact post-checkout handoff, delivery email, audit intake fields, and kit preview before paying.
...
- 2026-05-20: Re-ran `npm run check:site-links` and `npm run check:source-tag-coverage` after the handoff/pricing polish; both passed again with 66 HTML files and 342 emitted source tags fully covered.
