...
const output = [
  ...
  `- AI-stack template inbox submissions: ${(inboxAiStackChecker == null || inboxAiStackDownloadTeardown == null || inboxAiStackDownloadPricing == null || inboxAiStackTeardown == null || inboxAiStackPricing == null) ? "unknown" : inboxAiStackChecker + inboxAiStackDownloadTeardown + inboxAiStackDownloadPricing + inboxAiStackTeardown + inboxAiStackPricing} (${inboxAiStackChecker == null ? "unknown" : inboxAiStackChecker} checker, ${inboxAiStackDownloadTeardown == null ? "unknown" : inboxAiStackDownloadTeardown} download teardown, ${inboxAiStackDownloadPricing == null ? "unknown" : inboxAiStackDownloadPricing} download pricing, ${inboxAiStackTeardown == null ? "unknown" : inboxAiStackTeardown} general teardown, ${inboxAiStackPricing == null ? "unknown" : inboxAiStackPricing} general pricing)`,
