...
const output = [
  ...
  `- AI vendor risk assessment inbox submissions: ${sumMetrics([inboxHomepageAiRiskAssessment, inboxBlogIndexAiRiskAssessment, inboxFreeToolsAiRiskAssessment, inboxAiProcurementHubRiskAssessment, inboxCommunityAiRiskAssessment, inboxAiVendorRiskAssessmentSample, inboxAiVendorRiskAssessmentGuide, inboxAiVendorRiskAssessmentStack, inboxAiVendorRiskAssessmentTeardown, inboxAiVendorRiskAssessmentPricing]) == null ? "unknown" : sumMetrics([inboxHomepageAiRiskAssessment, inboxBlogIndexAiRiskAssessment, inboxFreeToolsAiRiskAssessment, inboxAiProcurementHubRiskAssessment, inboxCommunityAiRiskAssessment, inboxAiVendorRiskAssessmentSample, inboxAiVendorRiskAssessmentGuide, inboxAiVendorRiskAssessmentStack, inboxAiVendorRiskAssessmentTeardown, inboxAiVendorRiskAssessmentPricing])} (${inboxHomepageAiRiskAssessment == null ? "unknown" : inboxHomepageAiRiskAssessment} homepage wedge, ${inboxBlogIndexAiRiskAssessment == null ? "unknown" : inboxBlogIndexAiRiskAssessment} blog-index wedge, ${inboxFreeToolsAiRiskAssessment == null ? "unknown" : inboxFreeToolsAiRiskAssessment} free-tools wedge, ${inboxAiProcurementHubRiskAssessment == null ? "unknown" : inboxAiProcurementHubRiskAssessment} procurement hub wedge, ${inboxCommunityAiRiskAssessment == null ? "unknown" : inboxCommunityAiRiskAssessment} community reply, ${inboxAiVendorRiskAssessmentSample == null ? "unknown" : inboxAiVendorRiskAssessmentSample} page sample CTA, ${inboxAiVendorRiskAssessmentGuide == null ? "unknown" : inboxAiVendorRiskAssessmentGuide} page guide CTA, ${inboxAiVendorRiskAssessmentStack == null ? "unknown" : inboxAiVendorRiskAssessmentStack} page stack CTA, ${inboxAiVendorRiskAssessmentTeardown == null ? "unknown" : inboxAiVendorRiskAssessmentTeardown} page teardown CTA, ${inboxAiVendorRiskAssessmentPricing == null ? "unknown" : inboxAiVendorRiskAssessmentPricing} page pricing CTA)`,
