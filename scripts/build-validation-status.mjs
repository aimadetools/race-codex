...
const output = [
  ...
  `- Free async teardown source families: ${sumMetrics([inboxTeardownHomepage, inboxTeardownPricing, inboxTeardownAbout, inboxTeardownGenerator, inboxTeardownHub, inboxTeardownChecker, inboxTeardownTracker, inboxTeardownReviewBriefBuilder, inboxTeardownBlog, inboxTeardownOutreach, inboxTeardownOther]) == null ? "unknown" : sumMetrics([inboxTeardownHomepage, inboxTeardownPricing, inboxTeardownAbout, inboxTeardownGenerator, inboxTeardownHub, inboxTeardownChecker, inboxTeardownTracker, inboxTeardownReviewBriefBuilder, inboxTeardownBlog, inboxTeardownOutreach, inboxTeardownOther])} (${inboxTeardownHomepage == null ? "unknown" : inboxTeardownHomepage} homepage, ${inboxTeardownPricing == null ? "unknown" : inboxTeardownPricing} pricing, ${inboxTeardownAbout == null ? "unknown" : inboxTeardownAbout} about, ${inboxTeardownGenerator == null ? "unknown" : inboxTeardownGenerator} generator, ${inboxTeardownHub == null ? "unknown" : inboxTeardownHub} hub, ${inboxTeardownChecker == null ? "unknown" : inboxTeardownChecker} checker, ${inboxTeardownTracker == null ? "unknown" : inboxTeardownTracker} tracker, ${inboxTeardownReviewBriefBuilder == null ? "unknown" : inboxTeardownReviewBriefBuilder} review-brief-builder, ${inboxTeardownBlog == null ? "unknown" : inboxTeardownBlog} blog, ${inboxTeardownOutreach == null ? "unknown" : inboxTeardownOutreach} outreach, ${inboxTeardownOther == null ? "unknown" : inboxTeardownOther} other)`,
  ...
  `- AI-stack template inbox submissions: ${(inboxAiStackChecker == null || inboxAiStackTeardown == null || inboxAiStackPricing == null) ? "unknown" : inboxAiStackChecker + inboxAiStackTeardown + inboxAiStackPricing} (${inboxAiStackChecker == null ? "unknown" : inboxAiStackChecker} checker, ${inboxAiStackTeardown == null ? "unknown" : inboxAiStackTeardown} teardown, ${inboxAiStackPricing == null ? "unknown" : inboxAiStackPricing} pricing)`,
