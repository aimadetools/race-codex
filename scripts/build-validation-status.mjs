...
const output = [
  ...
  `- AI disclosure packet inbox submissions: ${(inboxAiDisclosurePacketStack == null || inboxAiDisclosurePacketNotice == null || inboxAiDisclosurePacketBrief == null || inboxAiDisclosurePacketTeardown == null || inboxAiDisclosurePacketPricing == null || inboxAiDisclosurePacketBottom == null || inboxPricingAiDisclosurePacket == null || inboxStartHereAiDisclosurePacket == null || inboxAuditRequestAiPacket == null || inboxSampleTeardownAiPacket == null || inboxKitPreviewAiPacket == null) ? "unknown" : inboxAiDisclosurePacketStack + inboxAiDisclosurePacketNotice + inboxAiDisclosurePacketBrief + inboxAiDisclosurePacketTeardown + inboxAiDisclosurePacketPricing + inboxAiDisclosurePacketBottom + inboxPricingAiDisclosurePacket + inboxStartHereAiDisclosurePacket + inboxAuditRequestAiPacket + inboxSampleTeardownAiPacket + inboxKitPreviewAiPacket} (${inboxAiDisclosurePacketStack == null ? "unknown" : inboxAiDisclosurePacketStack} stack bridge, ${inboxAiDisclosurePacketNotice == null ? "unknown" : inboxAiDisclosurePacketNotice} notice bridge, ${inboxAiDisclosurePacketBrief == null ? "unknown" : inboxAiDisclosurePacketBrief} brief bridge, ${inboxAiDisclosurePacketTeardown == null ? "unknown" : inboxAiDisclosurePacketTeardown} teardown, ${inboxAiDisclosurePacketPricing == null ? "unknown" : inboxAiDisclosurePacketPricing} pricing, ${inboxAiDisclosurePacketBottom == null ? "unknown" : inboxAiDisclosurePacketBottom} bottom CTA, ${inboxPricingAiDisclosurePacket == null ? "unknown" : inboxPricingAiDisclosurePacket} pricing page guide, ${inboxStartHereAiDisclosurePacket == null ? "unknown" : inboxStartHereAiDisclosurePacket} start-here guide, ${inboxAuditRequestAiPacket == null ? "unknown" : inboxAuditRequestAiPacket} audit-request guide, ${inboxSampleTeardownAiPacket == null ? "unknown" : inboxSampleTeardownAiPacket} sample-teardown guide, ${inboxKitPreviewAiPacket == null ? "unknown" : inboxKitPreviewAiPacket} kit-preview guide)`,
