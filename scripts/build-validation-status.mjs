...
const aiFirstEntryWatch = buildWatchedSourceGroup(contactInboxStatusText, [
  ...
  { tag: "start-here-ai-route-claude-template", label: "start-here Claude template" },
...
const dueDiligenceWatch = buildWatchedSourceGroup(contactInboxStatusText, [
  ...
  { tag: "ai-answer-library-due-diligence-risk-checklist", label: "answer-library risk-checklist" },
  { tag: "free-tools-ai-due-diligence-risk-checklist", label: "free-tools risk-checklist" },
  { tag: "pricing-ai-due-diligence-risk-checklist", label: "pricing risk-checklist" },
  { tag: "ai-procurement-hub-due-diligence-risk-checklist", label: "hub risk-checklist" },
  { tag: "start-here-ai-due-diligence-risk-checklist", label: "start-here risk-checklist" },
  { tag: "blog-index-ai-due-diligence-risk-checklist", label: "blog risk-checklist" },
  { tag: "route-chooser-due-diligence-risk-checklist", label: "route-chooser risk-checklist" },
  { tag: "ai-due-diligence-evidence-map-risk-checklist", label: "evidence-map risk-checklist" },
  { tag: "ai-framework-map-risk-checklist", label: "framework-map risk-checklist" },
  { tag: "ai-due-diligence-packet-builder-risk-checklist", label: "packet-builder risk-checklist" },
  { tag: "ai-due-diligence-scorecard-risk-checklist", label: "scorecard risk-checklist" },
  { tag: "ai-due-diligence-comparison-risk-checklist", label: "comparison risk-checklist" },
  { tag: "ai-due-diligence-template-risk-checklist", label: "template risk-checklist" },
  { tag: "ai-due-diligence-starter-pack", label: "due-diligence starter-pack" },
  { tag: "homepage-ai-due-diligence-starter-pack", label: "homepage starter-pack" },
  { tag: "pricing-ai-due-diligence-starter-pack", label: "pricing starter-pack" },
  { tag: "free-tools-ai-due-diligence-starter-pack", label: "free-tools starter-pack" },
  { tag: "start-here-ai-due-diligence-starter-pack", label: "start-here starter-pack" },
  { tag: "about-page-due-diligence-starter-pack", label: "about starter-pack" },
  { tag: "blog-index-ai-due-diligence-starter-pack", label: "blog starter-pack" },
  { tag: "ai-procurement-hub-due-diligence-starter-pack", label: "hub starter-pack" },
  { tag: "route-chooser-due-diligence-starter-pack", label: "route-chooser starter-pack" },
  { tag: "ai-answer-library-due-diligence-starter-pack", label: "answer-library starter-pack" },
  { tag: "ai-due-diligence-template-starter-pack", label: "template starter-pack" },
  { tag: "ai-due-diligence-scorecard-starter-pack", label: "scorecard starter-pack" },
  { tag: "ai-due-diligence-packet-builder-starter-pack", label: "packet-builder starter-pack" },
  { tag: "ai-due-diligence-evidence-map-starter-pack", label: "evidence-map starter-pack" },
  { tag: "ai-framework-map-starter-pack", label: "framework-map starter-pack" },
  { tag: "ai-due-diligence-comparison-starter-pack", label: "comparison starter-pack" },
  { tag: "ai-due-diligence-risk-checklist-starter-pack", label: "risk-checklist starter-pack" },
  { tag: "kit-preview-due-diligence-starter-pack", label: "kit-preview starter-pack" },
  { tag: "purchase-next-steps-due-diligence-starter-pack", label: "purchase-next-steps starter-pack" },
...
const claudeWatch = buildWatchedSourceGroup(contactInboxStatusText, [
  ...
  { tag: "free-tools-claude-answer-template", label: "free-tools template" },
  { tag: "free-tools-claude-answer-example", label: "free-tools example" },
  { tag: "free-tools-claude-answer-bank", label: "free-tools answer-bank" },
  ...
  { tag: "ai-procurement-hub-claude-answer-template", label: "hub template" },
  { tag: "ai-procurement-hub-claude-answer-example", label: "hub example" },
  { tag: "ai-procurement-hub-claude-answer-bank", label: "hub answer-bank" },
  { tag: "ai-procurement-hub-claude-path-guide", label: "hub path-guide" },
  { tag: "homepage-ai-route-claude-template", label: "homepage template" },
  { tag: "homepage-ai-route-claude-example", label: "homepage example" },
  { tag: "homepage-ai-route-claude-answer-bank", label: "homepage answer-bank" },
  { tag: "homepage-ai-route-claude-path-guide", label: "homepage path-guide" },
  { tag: "pricing-claude-answer-template", label: "pricing template" },
  { tag: "pricing-claude-answer-bank", label: "pricing answer-bank" },
  { tag: "pricing-claude-path-guide", label: "pricing path-guide" },
