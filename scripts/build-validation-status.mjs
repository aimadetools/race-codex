...
const output = [
  ...
  `- Sample-teardown inbox submissions: ${(inboxSampleTeardownHero == null || inboxSampleTeardownCta == null || inboxSampleTeardownPartner == null) ? "unknown" : inboxSampleTeardownHero + inboxSampleTeardownCta + inboxSampleTeardownPartner} (${inboxSampleTeardownHero == null ? "unknown" : inboxSampleTeardownHero} hero, ${inboxSampleTeardownCta == null ? "unknown" : inboxSampleTeardownCta} CTA, ${inboxSampleTeardownPartner == null ? "unknown" : inboxSampleTeardownPartner} partner)`,
