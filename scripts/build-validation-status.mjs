...
const output = [
  ...
  `- AI disclosure packet inbox submissions: ${(inboxAiDisclosurePacketStack == null || inboxAiDisclosurePacketNotice == null || inboxAiDisclosurePacketBrief == null || inboxAiDisclosurePacketTeardown == null || inboxAiDisclosurePacketPricing == null || inboxAiDisclosurePacketBottom == null || inboxAiDisclosurePacketSample == null || inboxPricingAiDisclosurePacket == null || inboxPricingAiPacketSample == null || inboxStartHereAiDisclosurePacket == null || inboxStartHereAiPacketSample == null || inboxAuditRequestAiPacket == null || inboxSampleTeardownAiPacket == null || inboxKitPreviewAiPacket == null || inboxHomepageAiPacketSample == null || inboxBlogIndexAiPacketSample == null || inboxFreeToolsAiPacketSample == null || inboxSampleAiPacketGuide == null || inboxSampleAiPacketStack == null || inboxSampleAiPacketTeardown == null || inboxSampleAiPacketPricing == null) ? "unknown" : inboxAiDisclosurePacketStack + inboxAiDisclosurePacketNotice + inboxAiDisclosurePacketBrief + inboxAiDisclosurePacketTeardown + inboxAiDisclosurePacketPricing + inboxAiDisclosurePacketBottom + inboxAiDisclosurePacketSample + inboxPricingAiDisclosurePacket + inboxPricingAiPacketSample + inboxStartHereAiDisclosurePacket + inboxStartHereAiPacketSample + inboxAuditRequestAiPacket + inboxSampleTeardownAiPacket + inboxKitPreviewAiPacket + inboxHomepageAiPacketSample + inboxBlogIndexAiPacketSample + inboxFreeToolsAiPacketSample + inboxSampleAiPacketGuide + inboxSampleAiPacketStack + inboxSampleAiPacketTeardown + inboxSampleAiPacketPricing} (${inboxAiDisclosurePacketStack == null ? "unknown" : inboxAiDisclosurePacketStack} stack bridge, ${inboxAiDisclosurePacketNotice == null ? "unknown" : inboxAiDisclosurePacketNotice} notice bridge, ${inboxAiDisclosurePacketBrief == null ? "unknown" : inboxAiDisclosurePacketBrief} brief bridge, ${inboxAiDisclosurePacketTeardown == null ? "unknown" : inboxAiDisclosurePacketTeardown} teardown, ${inboxAiDisclosurePacketPricing == null ? "unknown" : inboxAiDisclosurePacketPricing} pricing, ${inboxAiDisclosurePacketBottom == null ? "unknown" : inboxAiDisclosurePacketBottom} bottom CTA, ${inboxAiDisclosurePacketSample == null ? "unknown" : inboxAiDisclosurePacketSample} sample bridge, ${inboxPricingAiDisclosurePacket == null ? "unknown" : inboxPricingAiDisclosurePacket} pricing page guide, ${inboxPricingAiPacketSample == null ? "unknown" : inboxPricingAiPacketSample} pricing page sample, ${inboxStartHereAiDisclosurePacket == null ? "unknown" : inboxStartHereAiDisclosurePacket} start-here guide, ${inboxStartHereAiPacketSample == null ? "unknown" : inboxStartHereAiPacketSample} start-here sample, ${inboxAuditRequestAiPacket == null ? "unknown" : inboxAuditRequestAiPacket} audit-request guide, ${inboxSampleTeardownAiPacket == null ? "unknown" : inboxSampleTeardownAiPacket} sample-teardown guide, ${inboxKitPreviewAiPacket == null ? "unknown" : inboxKitPreviewAiPacket} kit-preview guide, ${inboxHomepageAiPacketSample == null ? "unknown" : inboxHomepageAiPacketSample} homepage sample, ${inboxBlogIndexAiPacketSample == null ? "unknown" : inboxBlogIndexAiPacketSample} blog-index sample, ${inboxFreeToolsAiPacketSample == null ? "unknown" : inboxFreeToolsAiPacketSample} free-tools sample, ${inboxSampleAiPacketGuide == null ? "unknown" : inboxSampleAiPacketGuide} sample page guide, ${inboxSampleAiPacketStack == null ? "unknown" : inboxSampleAiPacketStack} sample page stack, ${inboxSampleAiPacketTeardown == null ? "unknown" : inboxSampleAiPacketTeardown} sample page teardown, ${inboxSampleAiPacketPricing == null ? "unknown" : inboxSampleAiPacketPricing} sample page pricing)`,
